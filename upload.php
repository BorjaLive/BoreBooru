	...
	<body>
		...
		<div style="margin-left:20%">
			...
			<div class="uploadContainer">
				<form action="upload.php?mod=upload" method="post" enctype="multipart/form-data">
			...
			<div class="	uploadContainer">
				Eliminar por ID<br>
				<form action="upload.php?mod=delete" method="post" enctype="multipart/form-data">
					<input type="text" size="5" name="id" value="" placeholder="000000">
